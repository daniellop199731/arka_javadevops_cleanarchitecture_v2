package com.bancolombia.arka_javadevops_cleanarchitecture_v2.infrastructure.adapter.in.web.mapper;

import org.springframework.stereotype.Component;

import com.bancolombia.arka_javadevops_cleanarchitecture_v2.domain.model.Usuario;
import com.bancolombia.arka_javadevops_cleanarchitecture_v2.infrastructure.adapter.in.web.dto.UsuarioDto;
...
public class UsuarioWebMapper {
    ...
    public UsuarioDto toDto(Usuario usuario) {
        ...
        usuarioDto.setContrasennaUsuario(usuario.getContrasennaUsuario());
    ...
    public Usuario toModel(UsuarioDto usuarioDto) {
        ...
        usuario.setContrasennaUsuario(usuarioDto.getContrasennaUsuario());
